					...
					<div class="panel-body">
						<div class="top-stats-panel">
							<div class="daily-visit">
								<h4 class="widget-h">Sem Progress</h4>
			...
			<div class="col-md-3">
				<div class="mini-stat clearfix">
					...
					<div class="mini-stat-info">
						<span>75,000</span> College Fee Received
					</div>
				</div>
			</div>
			<div class="col-md-3">
				<div class="mini-stat clearfix">
					...
					<div class="mini-stat-info">
						<span>60,000</span> Hostel Fee Received
					</div>
				</div>
			</div>
			<div class="col-md-3">
				<div class="mini-stat clearfix">
					...
					<div class="mini-stat-info">
						<span>20,000</span> Bus Fee Received
					</div>
				</div>
			</div>
			<div class="col-md-3">
				<div class="mini-stat clearfix">
					...
					<div class="mini-stat-info">
						<span>1,200</span> Exam Fee Received
					</div>
				</div>
			</div>
		</div>
